...
<aside class="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col z-20">
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        <a href="/dashboard/settings"
            class="flex items-center gap-3 px-3 py-2.5 {{ $active === 'settings' ? 'bg-orange-50 text-primary' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} rounded-xl transition-colors font-medium">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-5 h-5">
                <path stroke-linecap="round" stroke-linejoin="round"
