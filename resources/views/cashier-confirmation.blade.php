...
<body class="bg-gray-100 min-h-screen flex justify-center">
    ...
    <div class="w-full max-w-[500px] bg-white min-h-screen relative shadow-2xl pb-24 mx-auto">
        ...
        <div
            ...
            <h1 class="font-bold text-lg text-gray-800">Order Summary</h1>
        </div>
        ...
        <div class="px-4 space-y-6">
            ...
            <div class="flex flex-col items-center">
                <p class="text-gray-600 text-sm mb-2">Order Number</p>
                ...
                <div class="w-full bg-[#fff8de] rounded-lg p-3 flex items-start gap-3">
                    ...
                    <p class="text-sm font-bold text-gray-800 leading-tight">
                        Show the QR code or <span class="text-gray-900">8-digit order number</span> to our cashier.
                    </p>
                </div>
            </div>
            ...
            <!-- Ordered Items -->
            <div>
                <h2 class="font-bold text-gray-900 mb-3 text-sm">Ordered Items</h2>
                ...
                <div class="space-y-1 text-sm pb-4 border-b border-dashed border-gray-200 mt-4">
                    ...
                    <div class="flex justify-between text-gray-600">
                        <span>Other fees <span class="inline-block align-middle"><svg xmlns="http://www.w3.org/2000/svg"
