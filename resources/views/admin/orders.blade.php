        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
                    ...
                    <div>
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
                            <table class="w-full">
                                <thead class="bg-gray-50 border-b border-gray-200">
                                    <tr>
                                        <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Item
                                        </th>
                                        <th class="px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase">Qty
                                        </th>
            ...
            <div class="flex items-center justify-end p-6 border-t border-gray-200 bg-gray-50 gap-3">
                ...
                <button id="printOrderBtn"
                    class="px-6 py-2.5 border border-gray-300 bg-gray-50 text-gray-700 font-semibold rounded-xl transition-colors flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor" class="w-4 h-4">
                        <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div class="flex items-center justify-between p-6 border-t border-gray-200 bg-gray-50">
                <button id="clearFilters"
                    class="text-gray-600 hover:text-gray-800 font-semibold text-sm transition-colors">
                    Clear All Filters
                </button>
                <div class="flex gap-3">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            printOrderBtn.addEventListener('click', () => {
                const orderNumber = document.getElementById('detailOrderNumber').textContent.replace(
                    'Order #', '');
                if (orderNumber) {
                    window.open(`/api/admin/orders/${orderNumber}/kitchen-receipt`, '_blank');
                }
            });
        });
